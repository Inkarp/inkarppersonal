      ...
      <div className>
        <ul className="border-t border-gray-200 p-3 pb-6">
          ...
          <li className="flex flex-col items-end">
            ...
            <div className="w-fit rounded-lg bg-blue-600/70 px-2 py-1 text-right text-sm text-white">
              90 percent?
            </div>
          </li>
          <li className="flex flex-col items-start">
        ...
        <div className="relative">
          ...
          <button className="absolute top-0 right-1 bottom-0 my-auto size-fit cursor-pointer rounded-full p-2 text-blue-600 hover:bg-gray-200 focus:bg-gray-200">
