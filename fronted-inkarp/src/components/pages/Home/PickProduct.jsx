...
export default function PickProduct() {
  ...
  // Parallax orbs (optional, already themed)
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-3">
            ...
            <div className="hidden md:block sticky top-6 h-[calc(100vh-20rem)]">
              <div className="rounded-3xl border border-gray-200 shadow-sm p-5">
                  ...
                  {productData.map((item, idx) => (
                    <li key={idx}>
                      <button
                        ...
                        className={`w-full text-left p-3 rounded-xl border transition group ${idx === selectedIndex
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <span
                            className={`h-2.5 w-2.5 rounded-full transition ${idx === selectedIndex ? "bg-[#E63946]" : "bg-gray-300 group-hover:bg-[#E63946]/60"
                              }`}
                          />
          ...
          <div className="md:col-span-9">
            <motion.div
              ...
              className="relative backdrop-blur px-4 sm:px-7 py-2"
            >
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                >
                  <motion.div
                    ...
                    className="relative w-full h-[280px] sm:h-[360px] rounded-2xl bg-gradient-to-br from-white to-white/50 border border-gray-200 flex items-center justify-center overflow-hidden"
                  >
                    ...
                    />
                    {/* moving glare (fixed top-0 class) */}
                    <motion.div
                      style={{ left: glare }}
                ...
                <div className="lg:col-span-2 flex flex-col justify-between">
                  <div className="space-y-4">
                    ...
                    <p className="font-[Roboto] text-sm sm:text-base mt-1">
